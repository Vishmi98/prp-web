...
import { EditMemberModalProps, TeamDataType } from "../../team.types";
import { updateMember } from "../../team.service";
import { addTeamValidationSchema } from "../../team.utils";

import { MAX_SIZE_MB } from "@/constants/data";
import CropModal from "@/components/ImageCropper";


const EditMemberModal: React.FC<EditMemberModalProps> = ({ isOpen, onClose, initialValues, reloadData }) => {
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            formData.append("memberId", String(initialValues.id));
