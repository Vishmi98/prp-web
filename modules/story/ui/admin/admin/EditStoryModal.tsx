...
import { EditStoryModalProps, StoryDataType } from "@/modules/story/story.types";
import { addStoryValidationSchema } from "@/modules/story/story.utils";
import { updateStory } from "@/modules/story/story.service";


const AddStoryModal: React.FC<EditStoryModalProps> = ({ isOpen, onClose, initialValues, reloadData }) => {
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            formData.append("storyId", String(initialValues.id));
        ...
        <div onClick={onClose} className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center cursor-pointer">
            <div onClick={(e) => e.stopPropagation()} className="bg-white rounded-lg w-full max-w-xl max-h-[90vh] overflow-hidden flex flex-col mx-3">
                <div className="flex justify-between items-center p-4">
                    <h2 className="font-semibold">Update Success Story</h2>
                            ...
                            <div className="flex flex-col gap-4 overflow-y-auto p-4 max-h-[60vh]">
                                ...
                                <label className="text-sm flex flex-col">
                                    ...
                                    {profileImage ? (
                                        ...
                                        <Image
                                            src={initialValues.profileImagePath}
                                            alt="Thumbnail Preview"
                                            width={150}
                                            height={150}
                                            className="mt-2"
