...
import { SessionDataType, SessionType } from "../../sessions.types";
import { updateSession } from "../../sessions.service";
import { addSessionValidationSchema } from "../../sessions.utils";

import { EditPackageModalProps } from "@/modules/packages/packages.types";


const EditSessionModal: FC<EditPackageModalProps & { initialValues: SessionDataType | null }> = ({
    isOpen,
    onClose,
    reloadData,
    initialValues,
