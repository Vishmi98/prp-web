        ...
        <div onClick={(event) => event.stopPropagation()} className="w-full max-w-xl rounded-lg bg-white">
            ...
            <Formik initialValues={initialValues} enableReinitialize validationSchema={faqValidationSchema} onSubmit={submit}>
                {({ isSubmitting }) => <Form className="space-y-3 p-4">
                    ...
                    <div className="flex flex-col gap-1"><label htmlFor="answer" className="text-sm font-medium text-gray-700">Answer <span className="text-red-500">*</span></label><Field as="textarea" id="answer" name="answer" rows={3} className="w-full resize-none rounded-md border border-gray-300 p-2 text-sm" /><ErrorMessage name="answer" component="div" className="text-xs text-red-600" /></div>
                    <div className="flex flex-col gap-1"><label htmlFor="answer2" className="text-sm font-medium text-gray-700">Answer2 <span className="text-red-500">*</span></label><Field as="textarea" id="answer2" name="answer2" rows={3} className="w-full resize-none rounded-md border border-gray-300 p-2 text-sm" /><ErrorMessage name="answer2" component="div" className="text-xs text-red-600" /></div>
                    <div className="flex flex-col gap-1"><label htmlFor="answer3" className="text-sm font-medium text-gray-700">Answer3 <span className="text-red-500">*</span></label><Field as="textarea" id="answer3" name="answer3" rows={3} className="w-full resize-none rounded-md border border-gray-300 p-2 text-sm" /><ErrorMessage name="answer3" component="div" className="text-xs text-red-600" /></div>
