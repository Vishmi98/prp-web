...
import { createPackage } from "../../packages.service";
import {
...
const AddPackageModal: FC<AddModalProps> = ({
    isOpen,
    onClose,
    handleReload,
}) => {
        ...
        >
            <div onClick={(e) => e.stopPropagation()} className="bg-white rounded-lg w-full max-w-xl max-h-[90vh] overflow-hidden flex flex-col mx-3">
                <div className="flex justify-between items-center p-4">
                    <h2 className="font-semibold">Add New Package</h2>
                    ...
                    {({ isSubmitting, setFieldValue, values }) => (
                        <Form>
                            <div className="flex flex-col gap-4 h-auto overflow-y-auto p-4">
                                ...
                                {/* Categories (Multi-select Checkbox Badges) */}
                                <div className="flex flex-col gap-1">
