...
`}
                                ...
                                {link.dropdown &&
                                    openDropdown === link.label && (
                                        <div className="absolute top-full left-0 mt-0.5 w-70 bg-white shadow-2xl rounded-md border border-gray-200 py-3 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
